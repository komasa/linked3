/**
 * Linked3 Eco Content JS
 * Extracted from: admin/views/dashboard/partials/eco-content.php
 * v29.1.0 Step 4: Inline JS extracted to assets/js/linked3-eco-content.js
 * Localized via wp_localize_script('linked3-eco-content', 'linked3_eco_content', {...})
 *   Keys: ajax_url, cw_mode, nonce, publish_url, edit_url, preview_url
 */

(function(){
    var ajaxUrl = 'window.linked3_eco_content.ajax_url';
    var nonce = 'window.linked3_eco_content.nonce';
    var cwMode = 'window.linked3_eco_content.cw_mode';
            ...
            fetch(ajaxUrl, {method:'POST', body:fd, credentials:'same-origin'})
                ...
                .then(function(data){
                    ...
                    if (data.success) {
                        ...
                        var distUrl = 'window.linked3_eco_content.publish_url';
                    ...
                    if (data.success) {
                        ...
                        results.forEach(function(r, i){
                            ...
                            if (r.post_id) {
                                ...
                                var editUrl = 'window.linked3_eco_content.edit_url' + r.post_id;
                                var viewUrl = 'window.linked3_eco_content.preview_url' + r.post_id;
