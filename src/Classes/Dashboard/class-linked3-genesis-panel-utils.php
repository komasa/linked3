...
class Linked3_Genesis_Panel_Utils
{
        public static function enforcePanelCount(array $nodes, int $targetPanels, string $script, string $styleName) : mixed { return Linked3_Genesis_Panel_Renderer::enforcePanelCount($nodes, $targetPanels, $script, $styleName); }

        public static function splitByChapters(string $script, string $marker = 'auto') : mixed { return Linked3_Genesis_Panel_Renderer::splitByChapters($script, $marker); }

        public static function genesisRefineAndSplit(string $script, int $targetPanels, string $styleName, string $styleId = '') : mixed { return Linked3_Genesis_Panel_Renderer::genesisRefineAndSplit($script, $targetPanels, $styleName, $styleId); }

        public static function genesisFPExtractCores(string $script, int $targetPanels, string $styleName, bool $isAuto = false, string $styleId = '') : mixed { return Linked3_Genesis_Panel_Renderer::genesisFPExtractCores($script, $targetPanels, $styleName, $isAuto, $styleId); }

        public static function parseFPNodesJson(string $raw) : mixed { return Linked3_Genesis_FP_Utils::parseFPNodesJson($raw); }

        public static function normalizeFPNodes(array $nodes) : mixed { return Linked3_Genesis_FP_Utils::normalizeFPNodes($nodes); }
