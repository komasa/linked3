...
final class GenesisProcessor
{
     ...
     */
     ...
     { return GenesisHelpers::genesisParallelGeneratePrompts($nodes, $styleId, $platform, $styleName); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::genesisSerialPrompts($nodes, $providerSlug, $model, $styleName, $platform, $styleId, $seedDNA); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::genesisBuildNodePrompt($node, $styleName, $platform, $styleId, $seedDNA); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::cleanAIPrompt($raw, $platform); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::isAIPromptDegraded($prompt); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::enforcePanelCount($nodes, $targetPanels, $script, $styleName); }
    /**
     * v7.2.0: 按章节标记拆分剧本
     *
     * 支持多种章节标记:
     ...
     */
     ...
     { return GenesisHelpers::splitByChapters($script, $marker); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::genesisRefineAndSplit($script, $targetPanels, $styleName, $styleId); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::getStyleAdaptiveExamples($styleId, $styleName); }
    /**
     * v7.4.0: 获取风格提示词 (从 StyleEngine 加载)
     */
        public static function getStyleHint(string $styleId, string $styleName): string
     { return GenesisHelpers::getStyleHint($styleId, $styleName); }
    /**
     ...
     */
     ...
     { return GenesisHelpers::parseFPNodesJson($raw); }
    /**
