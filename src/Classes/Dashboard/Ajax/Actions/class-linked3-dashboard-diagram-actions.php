...
class Linked3_Dashboard_Diagram_Actions extends Linked3_Dashboard_Base_Ajax_Action
{
     ...
     *             Linked3_Dashboard_Ajax_Registrar::ajax_diagram_generate().
     *             Will be migrated into this class in a future version.
     */
    public static function diagram_generate() : mixed {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_diagram_generate();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_diagram_validate().
     *             Will be migrated into this class in a future version.
     */
    public static function diagram_validate() : mixed     {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_diagram_validate();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_diagram_types().
     *             Will be migrated into this class in a future version.
     */
    public static function diagram_types()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_diagram_types();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_diagram_generate_multi().
     *             Will be migrated into this class in a future version.
     */
    public static function diagram_generate_multi()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_diagram_generate_multi();
    }
}
