...
class Linked3_Dashboard_Video_Actions extends Linked3_Dashboard_Base_Ajax_Action
{
     ...
     *             Linked3_Dashboard_Ajax_Registrar::ajax_video_generate_script().
     *             Will be migrated into this class in a future version.
     */
    public static function video_generate_script() : mixed {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_video_generate_script();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_video_outline().
     *             Will be migrated into this class in a future version.
     */
    public static function video_outline() : mixed     {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_video_outline();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_video_segment().
     *             Will be migrated into this class in a future version.
     */
    public static function video_segment()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_video_segment();
    }
}
