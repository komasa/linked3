...
class Linked3_Dashboard_AIConfig_Actions extends Linked3_Dashboard_Base_Ajax_Action
{
     ...
     *             Linked3_Dashboard_Ajax_Registrar::ajax_sync_models().
     *             Will be migrated into this class in a future version.
     */
    public static function sync_models() : mixed {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_sync_models();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_ai_suffix().
     *             Will be migrated into this class in a future version.
     */
    public static function save_ai_suffix() : mixed     {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_ai_suffix();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_advanced().
     *             Will be migrated into this class in a future version.
     */
    public static function save_advanced()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_advanced();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_custom_apis().
     *             Will be migrated into this class in a future version.
     */
    public static function save_custom_apis()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_custom_apis();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_provider_config().
     *             Will be migrated into this class in a future version.
     */
    public static function save_provider_config()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_provider_config();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_seo_enhance().
     *             Will be migrated into this class in a future version.
     */
    public static function save_seo_enhance()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_seo_enhance();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_image_settings().
     *             Will be migrated into this class in a future version.
     */
    public static function save_image_settings()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_image_settings();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_test_image_station().
     *             Will be migrated into this class in a future version.
     */
    public static function test_image_station()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_test_image_station();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_sync_image_models().
     *             Will be migrated into this class in a future version.
     */
    public static function sync_image_models()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_sync_image_models();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_geo().
     *             Will be migrated into this class in a future version.
     */
    public static function save_geo()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_geo();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_save_ai_search_keys().
     *             Will be migrated into this class in a future version.
     */
    public static function save_ai_search_keys()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_save_ai_search_keys();
    }
     ...
     * @deprecated 27.1.0 This delegate exists for backward compatibility.
     *             The actual implementation lives in
     *             Linked3_Dashboard_Ajax_Registrar::ajax_regen_llms_txt().
     *             Will be migrated into this class in a future version.
     */
    public static function regen_llms_txt()
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_regen_llms_txt();
    }
}
