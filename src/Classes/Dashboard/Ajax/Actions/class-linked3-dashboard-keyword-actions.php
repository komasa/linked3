 ...
 *
 * Migrated from Linked3_Dashboard_Ajax_Registrar (God Class) in G2.1.
...
class Linked3_Dashboard_Keyword_Actions extends Linked3_Dashboard_Base_Ajax_Action
{
     ...
     * AJAX: AI 生成长尾关键词。
     */
    public static function keyword_generate_tail()
    : void {
        if (!current_user_can('manage_options')) {
            wp_send_json_error(['message' => __('无权限', 'linked3')], 403);
        }
     ...
     * AJAX: 批量生成文章。
     */
    public static function keyword_batch_generate()
    : void {
        if (!current_user_can('manage_options')) {
            wp_send_json_error(['message' => __('无权限', 'linked3')], 403);
        }
    ...
    public static function kw_save_library() : mixed     {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_kw_save_library();
    }
    ...
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_kw_cron_enable();
    }
    ...
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_kw_cron_disable();
    }
    ...
    {
        return \Linked3\Classes\Dashboard\Linked3_Dashboard_Ajax_Registrar::ajax_kw_cron_status();
    }
}
