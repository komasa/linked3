...
final class Linked3_Dashboard_Ajax_Registrar_Legacy
{
    /**
    ...
    : void {
        ...
        // 模板 CRUD AJAX
        // G2.1: Template actions migrated to Linked3_Dashboard_Template_Actions
        // (self-registered via Linked3_Dashboard_Ajax_Registrar::register())
        ...
        // G2.1: Keyword actions migrated to Linked3_Dashboard_Keyword_Actions
        ...
        // 已在 v27.1.0 (P10) 拆分到 Linked3_Dashboard_Ajax_Genesis 独立类,
        // 此处仅做转发注册, 保持向后兼容 (handler 实现仍在本类中, 待 step 2 迁移).
        \Linked3\Classes\Dashboard\Ajax\Linked3_Dashboard_Ajax_Genesis::register();
        // v7.1.5: WP-Cron 回调
        add_action('linked3_genesis_run_job', [__CLASS__, 'cron_genesis_run_job']);
        // G2.1: Queue actions migrated to Linked3_Dashboard_Queue_Actions
    ...
    /**
     * AJAX: 添加模板
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Template_Actions::template_add()
     */

    /**
     * AJAX: 更新模板
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Template_Actions::template_update()
     */

    /**
     * AJAX: 删除模板
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Template_Actions::template_delete()
     */

    /**
     * AJAX: 获取单个模板
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Template_Actions::template_get()
     */
    ...
    /**
     * AJAX: 采集热词。
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Keyword_Actions::keyword_fetch_hot()
     */
    public static function ajax_keyword_fetch_hot() : mixed {
        return Ajax\Actions\Linked3_Dashboard_Keyword_Actions::keyword_fetch_hot();
    }

    /**
     * AJAX: AI 生成长尾关键词。
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Keyword_Actions::keyword_generate_tail()
     */
    public static function ajax_keyword_generate_tail() : mixed     {
        return Ajax\Actions\Linked3_Dashboard_Keyword_Actions::keyword_generate_tail();
    }

    /**
     * AJAX: 批量生成文章。
     * @deprecated G2.1 Migrated to Linked3_Dashboard_Keyword_Actions::keyword_batch_generate()
     */
    public static function ajax_keyword_batch_generate() : mixed {
        return Ajax\Actions\Linked3_Dashboard_Keyword_Actions::keyword_batch_generate();
    }
