...
class HealthMonitor {
    public function check(): array {
        ...
        return [
            ...
            'logger'          => class_exists('\Linked3\Includes\Log\Logger'),
            ...
            // AI 管线
            'provider_health' => class_exists('\Linked3\Classes\AI\Pipeline\ProviderHealthCheck'),
            'failover'        => class_exists('\Linked3\Classes\AI\Pipeline\ProviderFailover'),
            'token_meter'     => class_exists('\Linked3\Classes\AI\Pipeline\TokenMeter'),
            'key_pool'        => class_exists('\Linked3\Classes\AI\Pipeline\KeyPool'),
            'prompt_engine'   => class_exists('\Linked3\Classes\AI\Pipeline\PromptEngine'),
            'content_scorer'  => class_exists('\Linked3\Classes\AI\Pipeline\ContentQualityScorer'),
            'stream_output'   => class_exists('\Linked3\Classes\AI\Pipeline\StreamOutput'),
            'cost_reporter'   => class_exists('\Linked3\Classes\AI\Pipeline\CostReporter'),
            'prompt_cache'    => class_exists('\Linked3\Classes\AI\Pipeline\PromptCache'),
            // 安全
            'security_validator' => class_exists('\Linked3\Classes\Security\SecurityValidator'),
            'rate_limiter'       => class_exists('\Linked3\Classes\Security\RateLimiterV2'),
            'async_queue'        => class_exists('\Linked3\Classes\Security\AsyncQueue'),
            ...
            'subscription'       => class_exists('\Linked3\Classes\Billing\SubscriptionManagerV2'),
            ...
            // 规模
            'vector_incremental' => class_exists('\Linked3\Classes\Scale\VectorIncremental'),
