...
class Linked3_Book_Ajax_Actions {
     ...
     * 启动写书工厂
     */
        public static function start() : mixed { return Linked3_Book_Ajax_Pipeline::start(); }
     ...
     */
        public static function start_async() : mixed { return Linked3_Book_Ajax_Pipeline::start_async(); }

    /**
     * v18.11: 取消异步执行
     */
        public static function cancel_async() { return Linked3_Book_Ajax_Pipeline::cancel_async(); }

    /**
     * 查询进度
     */
        public static function progress() { return Linked3_Book_Ajax_Pipeline::progress(); }

    /**
     * 章节级重生成 (Q4盲区)
     */
        public static function regenerate_section() { return Linked3_Book_Ajax_Pipeline::regenerate_section(); }

    /**
     * 下载书稿 (Q6盲区)
     */
        public static function download() { return Linked3_Book_Ajax_Pipeline::download(); }

    /**
     * 断线重连恢复 (Q2盲区)
     */
        public static function resume() { return Linked3_Book_Ajax_Pipeline::resume(); }

    /**
     * 大纲回退 (Q5盲区)
     */
        public static function rollback_outline() { return Linked3_Book_Ajax_Pipeline::rollback_outline(); }

    /**
     * R2修复: 分步执行单节扩写
     * 前端轮询触发, 每次执行一节, 避免PHP超时
     */
        public static function run_step() { return Linked3_Book_Ajax_Pipeline::run_step(); }

    /**
     * N1+N3: 获取所有提示词 (供前端显示/编辑)
     */
        public static function get_prompts() { return Linked3_Book_Ajax_Prompts::get_prompts(); }

    /**
     * N1+N3: 保存用户修改的提示词
     */
        public static function save_prompt() { return Linked3_Book_Ajax_Prompts::save_prompt(); }

    /**
     * N3+N5: 预览提示词 (根据书名/类型/模式填充变量)
     */
        public static function preview_prompt() { return Linked3_Book_Ajax_Prompts::preview_prompt(); }
