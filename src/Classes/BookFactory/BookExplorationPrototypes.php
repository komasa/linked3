...
class BookExplorationPrototypes {
	...
	private static $prototypes = array(
		...
		'book' => array(
			'key'         => 'book',
			'name'        => __('写书式探索', 'linked3'),
			'description' => __('通过写书发现真理 — 系统化知识整理与真理萃取', 'linked3'),
			'category'    => 'knowledge',
			'best_for'    => array( '知识体系构建', '理论梳理', '学习总结', '经验沉淀' ),
			'process'     => array( '演示', '探索', '大纲', '扩写', '拼接', '审阅' ),
			'output_type' => 'book',
			'prompt_style' => __('系统化、结构化、逻辑严密', 'linked3'),
		...
		'meditative' => array(
			'key'         => 'meditative',
			'name'        => __('冥想式探索', 'linked3'),
			'description' => __('通过内观发现真理 — 东方智慧的直觉路径', 'linked3'),
			...
			'prompt_style' => __('内观、觉知、非二元', 'linked3'),
