...
use Linked3\Classes\ContentWriter\Prompt\TagsPromptBuilder;
...
final class GenerateTagsAction extends ContentWriterBaseAjaxAction
{
    public function handle(): void {
        ...
        $prompt = (new \Linked3\Classes\ContentWriter\Prompt\TagsPromptBuilder())->build(['title' => $title, 'keyword' => $keyword]);
        try { // v19.3.0: AI 调用容错
