...
namespace Linked3\Classes\Genesis;
    use Linked3_Script_Factory_Trait;

if (!defined('ABSPATH')) exit;

if (!trait_exists('Linked3_Script_Factory_Trait')) {
    require_once __DIR__ . '/trait-linked3-script-factory.php';
}

class Linked3_Charts_Factory {
    private $bands = [
        ...
        public function __construct() { return Linked3_Charts_Factory_Helpers::__construct(); }

        public function compile(array $context) : mixed { return Linked3_Charts_Factory_Helpers::compile($context); }

        public function split_long_article(string $article, int $target_count) : mixed { return Linked3_Charts_Factory_Helpers::split_long_article($article, $target_count); }

        public function split_by_chinese_headers(string $article) : mixed { return Linked3_Charts_Factory_Helpers::split_by_chinese_headers($article); }

        public function split_by_paragraphs(string $article, int $target_count) : mixed { return Linked3_Charts_Factory_Helpers::split_by_paragraphs($article, $target_count); }
