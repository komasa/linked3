 ...
 *   - 优先调用 Linked3_Skeleton_Library::route() (v8.1.0 引用但尚未实现, 此处防御性 class_exists)
 *   - 兜底: 用 L1+L2 简单查表
 *
...
class Linked3_Scene_Axis
{
     ...
     */
        public static function get_l1_types() : mixed { return Linked3_Scene_Axis_Utils::get_l1_types(); }
     ...
     * @return array
     */
        public static function get_l1_flat() : mixed { return Linked3_Scene_Axis_Utils::get_l1_flat(); }
     ...
     * @return array
     */
        public static function get_l2_columns() : mixed { return Linked3_Scene_Axis_Utils::get_l2_columns(); }
     ...
     * @return array
     */
        public static function get_l3_souls() : mixed { return Linked3_Scene_Axis_Utils::get_l3_souls(); }

    /**
     * 3.6 骨架路由 (S13) — 三轴选择 → 自动路由骨架
     *
     * 路由优先级:
     *   1. 调用 Linked3_Skeleton_Library::route(l1, l2, l3) (若存在)
     *   2. L3 → L2 → L1 兜底查表
     *
     ...
     */
        public static function route_skeleton(string $l1, string $l2, string $l3) : mixed { return Linked3_Scene_Axis_Utils::route_skeleton($l1, $l2, $l3); }
     ...
     * Return: {l1, l2, l3}
     */
        public static function ajax_get_axes() : mixed { return Linked3_Scene_Detector::ajax_get_axes(); }
