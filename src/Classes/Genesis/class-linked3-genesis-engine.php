...
class Linked3_Genesis_AtomIndex {
    private static ?Linked3_Genesis_AtomIndex $instance = null;
    private array $data = [];

    public static function instance(): Linked3_Genesis_AtomIndex {
    ...
    public function getAtom(string $atomId): ?array {
        ...
        public function searchKeyword(string $keyword) : mixed { return Linked3_Genesis_Engine_Extras::searchKeyword($keyword); }

        public function getByType(string $type) : mixed { return Linked3_Genesis_Engine_Extras::getByType($type); }

        public function getCharacters() : mixed { return Linked3_Genesis_Engine_Helpers::getCharacters(); }

        public function getScenes() : mixed { return Linked3_Genesis_Engine_Helpers::getScenes(); }

        public function getTemplates() : mixed { return Linked3_Genesis_Engine_Helpers::getTemplates(); }
...
class Linked3_Genesis_AtomSelector {
    private Linked3_Genesis_AtomIndex $index;

    public function __construct() {
        $this->index = Linked3_Genesis_AtomIndex::instance();
    }
...
class Linked3_Genesis_Bootstrap {
    ...
    public static function boot(): void {
        ...
        $container->set('genesis.atom_index', fn() => Linked3_Genesis_AtomIndex::instance());
