...
class Linked3_Scene_Axis_Utils
{
    ...
    {
        // 1) 委托 Linked3_Skeleton_Library (v8.1.0 引用, 防御性 class_exists)
        if (class_exists('\Linked3\Classes\Genesis\Linked3_Skeleton_Library') && method_exists('\Linked3\Classes\Genesis\Linked3_Skeleton_Library', 'route')) {
            try {
                $sk = \Linked3_Skeleton_Library::route($l1, $l2, $l3);
