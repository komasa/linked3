<?php
/**
 * Seed Admin — AJAX Handlers (G4.1 split from Linked3_Seed_Admin).
 *
 * @package Linked3
...
class Linked3_Seed_Admin_Ajax
{
    ...
    : void {
        ...
        // 唯一性检查
        $existing = Linked3_Genesis_Seed_CPT::get_by_seed_id($data['seed_id']);
        ...
        if (!empty($data['post_id'])) {
            ...
            Linked3_Genesis_Seed_CPT::update_meta($post_id, $data);
        } else {
            // 新建
            $post_id = Linked3_Genesis_Seed_CPT::create($data);
    ...
    : void {
        ...
        $count = Linked3_Genesis_Seed_CPT::trash_all();
    ...
    : void {
        ...
        $seed = Linked3_Genesis_Seed_CPT::get($post_id);
        if (!$seed) {
