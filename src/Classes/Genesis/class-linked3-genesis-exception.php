 ...
 * 统一错误码枚举
 */
class Linked3_Genesis_ErrorCode {
    // 网络错误
...
class Linked3_Genesis_Exception extends \Exception {
    ...
    public function __construct($message = '', $error_code = Linked3_Genesis_ErrorCode::E_UNKNOWN, $context = [], $previous = null) {
    ...
    public function toResponse() : mixed {
        return Linked3_Genesis_ErrorCode::to_response(
            $this->error_code,
            $this->getMessage(),
            $this->context
        );
    ...
    public static function from($e, $context = []) : mixed {
        ...
        $code = Linked3_Genesis_ErrorCode::infer($e);
