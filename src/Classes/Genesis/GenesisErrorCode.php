...
class GenesisErrorCode {
    ...
    public static $messages = [
        self::E_NETWORK_TIMEOUT    => __('网络请求超时', 'linked3'),
        self::E_NETWORK_CONN       => __('无法连接到服务器', 'linked3'),
        self::E_NETWORK_DNS        => __('DNS解析失败', 'linked3'),
        self::E_API_KEY_INVALID    => __('API Key 无效或未配置', 'linked3'),
        self::E_API_QUOTA          => __('API 余额不足', 'linked3'),
        self::E_API_RATE_LIMIT     => __('API 限流 (429)', 'linked3'),
        self::E_API_MODEL          => __('AI 模型不可用', 'linked3'),
        self::E_API_RESPONSE       => __('AI 响应格式异常', 'linked3'),
        self::E_PARSE_SCRIPT       => __('剧本解析失败', 'linked3'),
        self::E_PARSE_JSON         => __('JSON 解析失败', 'linked3'),
        self::E_PARSE_STRUCTURE    => __('数据结构不符合预期', 'linked3'),
        self::E_SEED_NOT_FOUND     => __('SEED 不存在', 'linked3'),
        self::E_SEED_LOCKED        => __('SEED 已锁定, 不可修改', 'linked3'),
        self::E_SEED_TYPE          => __('SEED 类型不匹配', 'linked3'),
        self::E_PQS_CORE_FAILED    => __('PQS 核心维度校验失败', 'linked3'),
        self::E_PQS_RETRY_EXHAUST  => __('PQS 回流重试次数耗尽', 'linked3'),
        self::E_SYSTEM_MEMORY      => __('内存不足', 'linked3'),
        self::E_SYSTEM_PERMISSION  => __('权限不足', 'linked3'),
        self::E_SYSTEM_CONFIG      => __('系统配置错误', 'linked3'),
        self::E_UNKNOWN            => __('未知错误', 'linked3'),
    ];
