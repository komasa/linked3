...
class Linked3_Genesis_Recommendation_Ajax
{
    ...
    public static function ajax_engine_call(): void
    {
        ...
        if (!class_exists('\Linked3\Classes\Genesis\Linked3_Genesis_9Engines')) {
        ...
        try {
            ...
            if ($engine === 'industry') {
                $result = Linked3_Genesis_9Engines::$method($content, $industry);
            } elseif ($engine === 'market') {
                $result = Linked3_Genesis_9Engines::$method($content, $industry);
            } else {
                $result = Linked3_Genesis_9Engines::$method($content);
            }
    ...
    public static function ajax_recommend(): void
    {
        ...
        if (!class_exists('\Linked3\Classes\Genesis\Linked3_Genesis_RecommendationEngine')) {
            wp_send_json_error(['message' => esc_html__('推荐引擎未加载', 'linked3')]);
        }

        try {
            $engine = new Linked3_Genesis_RecommendationEngine();
    ...
    public static function ajax_styles_filtered(): void
    {
        ...
        $all_styles = Linked3_Genesis_StyleEngine::getAllStyles();
...
add_action('init', [Linked3_Genesis_Recommendation_Ajax::class, 'init'], 20);
