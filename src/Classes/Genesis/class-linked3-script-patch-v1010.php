...
class Linked3_Script_Patch_V1010 {
    ...
    // ================================================================
        ...
        public static function ajax_video_generate() : mixed { return Linked3_Script_Patch_Handlers::ajax_video_generate(); }
    ...
    // ================================================================
        ...
        public static function ajax_charts_generate() : mixed { return Linked3_Script_Patch_Handlers::ajax_charts_generate(); }
    ...
    private static function load_seed_dna(array $seedRefs): array {
        ...
        if (empty($seedRefs) || !class_exists('\Linked3\Classes\Genesis\Linked3_Genesis_Seed_CPT')) return $dna;
...
add_action('init', ['\Linked3\Classes\Genesis\Linked3_Script_Patch_V1010', 'register'], 5);
