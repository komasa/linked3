...
class QualityLoop
{
     ...
     */
        public static function pqs_fix_suggest(array $pqs_result, array $shot_data) : mixed { return QualityChecker::pqs_fix_suggest($pqs_result, $shot_data); }

    /**
     * 5.2 批量分镜一致性校验报告 (S20) — 保留原方法
     */
        public static function batch_consistency_check(array $shots) : mixed { return QualityChecker::batch_consistency_check($shots); }
