...
class Linked3_Genesis_Patch_Stage3
{
    public static function ajax_seed_generate_full() : void {
        ...
        try {
            ...
            if (class_exists('\Linked3\Classes\Genesis\Linked3_Genesis_SeedDNA')) {
                $styleConfig = class_exists('\Linked3\Classes\Genesis\Linked3_Genesis_StyleEngine')
                    ? \Linked3_Genesis_StyleEngine::load($styleId) : [];
            ...
            if (!class_exists('\Linked3\Classes\Genesis\Linked3_Genesis_Seed_CPT') || !method_exists('\Linked3\Classes\Genesis\Linked3_Genesis_Seed_CPT', 'create')) {
            ...
            if (!empty($dna['characters'])) {
                foreach ($dna['characters'] as $idx => $char) {
                    ...
                    $postId = \Linked3_Genesis_Seed_CPT::create([
                        'title' => $charName . ' (角色)',
                        'seed_id' => $seedId,
                        'seed_type' => 'fixed',
                        'seed_category' => 'char',
    ...
    public static function ajax_v9_stage1_fixed() : void {
        ...
        try {
            ...
            if (($l1_type === 'auto' || $l2_column === 'auto' || $l3_soul === 'auto')
                && class_exists('\Linked3\Classes\Genesis\Linked3_Scene_Axis')
                && method_exists('\Linked3\Classes\Genesis\Linked3_Scene_Axis', 'auto_detect_from_script')) {
                try {
            ...
            if ($useAi && class_exists('\Linked3\Classes\Genesis\Linked3_Story_Pipeline') && method_exists('\Linked3\Classes\Genesis\Linked3_Story_Pipeline', 'parse')) {
                try {
            ...
            if (class_exists('\Linked3\Classes\Genesis\Linked3_Scene_Axis')) {
                try { $skeletonId = \Linked3_Scene_Axis::route_skeleton($l1_type, $l2_column, $l3_soul); } catch (\Throwable $e) {}
            }
