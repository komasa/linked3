    ...
    public static function get_l1_types(): array
    {
        return [
            [
                ...
                'scenes' => [
                    ['id' => 'street_cafe',      'name' => __('街头咖啡馆', 'linked3'), 'name_en' => 'street cafe',         'prompt_keywords' => 'urban street, cafe storefront, pedestrian flow'],
                    ['id' => 'subway_platform',  'name' => __('地铁站台', 'linked3'),   'name_en' => 'subway platform',     'prompt_keywords' => 'underground subway platform, fluorescent light, train arrival'],
                    ['id' => 'office_tower',     'name' => __('办公写字楼', 'linked3'), 'name_en' => 'office tower',        'prompt_keywords' => 'modern office tower, glass facade, workday rhythm'],
                    ['id' => 'shopping_mall',    'name' => __('商场购物', 'linked3'),   'name_en' => 'shopping mall',       'prompt_keywords' => 'shopping mall interior, storefronts, crowd flow'],
                    ['id' => 'night_market',     'name' => __('夜市小吃', 'linked3'),   'name_en' => 'night market',        'prompt_keywords' => 'night market, food stalls, neon signs'],
                    ['id' => 'rooftop_night',    'name' => __('天台夜色', 'linked3'),   'name_en' => 'rooftop at night',    'prompt_keywords' => 'city rooftop, night skyline, wind'],
                ],
            ],
            [
                'category_id'   => 'nature',
                ...
                'scenes' => [
                    ['id' => 'mountain_mist',    'name' => __('山峦雾境', 'linked3'),   'name_en' => 'mountain mist',       'prompt_keywords' => 'mountain range, drifting mist, dawn light'],
                    ['id' => 'coastal_cliff',    'name' => __('海岸悬崖', 'linked3'),   'name_en' => 'coastal cliff',       'prompt_keywords' => 'coastal cliff, crashing waves, sea spray'],
                    ['id' => 'grassland_sunset', 'name' => __('草原日落', 'linked3'),   'name_en' => 'grassland sunset',    'prompt_keywords' => 'vast grassland, golden sunset, lone tree'],
                    ['id' => 'desert_stars',     'name' => __('沙漠星空', 'linked3'),   'name_en' => 'desert starscape',    'prompt_keywords' => 'desert dunes, milky way, profound silence'],
                    ['id' => 'snowy_dawn',       'name' => __('雪山黎明', 'linked3'),   'name_en' => 'snowy dawn',          'prompt_keywords' => 'snow mountain, dawn alpenglow, untouched snow'],
                    ['id' => 'forest_path',      'name' => __('森林小径', 'linked3'),   'name_en' => 'forest path',         'prompt_keywords' => 'forest trail, sunbeams through canopy, moss'],
                    ['id' => 'rainforest_falls', 'name' => __('雨林瀑布', 'linked3'),   'name_en' => 'rainforest falls',    'prompt_keywords' => 'tropical rainforest, waterfall, misty spray'],
                ],
            ],
            [
                ...
                'scenes' => [
                    ['id' => 'living_room',      'name' => __('客厅', 'linked3'),       'name_en' => 'living room',         'prompt_keywords' => 'cozy living room, sofa, warm lamp light'],
                    ['id' => 'kitchen',          'name' => __('厨房', 'linked3'),       'name_en' => 'kitchen',             'prompt_keywords' => 'home kitchen, utensils, morning sunlight'],
                    ['id' => 'bedroom',          'name' => __('卧室', 'linked3'),       'name_en' => 'bedroom',             'prompt_keywords' => 'quiet bedroom, made bed, soft curtain light'],
                    ['id' => 'study_room',       'name' => __('书房', 'linked3'),       'name_en' => 'study room',          'prompt_keywords' => 'study room, bookshelves, desk lamp'],
                    ['id' => 'bathroom',         'name' => __('浴室', 'linked3'),       'name_en' => 'bathroom',            'prompt_keywords' => 'clean bathroom, mirror, steam haze'],
                    ['id' => 'balcony',          'name' => __('阳台', 'linked3'),       'name_en' => 'balcony',             'prompt_keywords' => 'apartment balcony, potted plants, evening sun'],
                ],
            ],
            [
                ...
                'scenes' => [
                    ['id' => 'fine_dining',      'name' => __('高级餐厅', 'linked3'),   'name_en' => 'fine dining',         'prompt_keywords' => 'fine dining restaurant, candlelight, white tablecloth'],
                    ['id' => 'boutique_hotel',   'name' => __('精品酒店', 'linked3'),   'name_en' => 'boutique hotel',      'prompt_keywords' => 'boutique hotel lobby, designer furniture, ambient light'],
                    ['id' => 'indie_bookstore',  'name' => __('独立书店', 'linked3'),   'name_en' => 'indie bookstore',     'prompt_keywords' => 'indie bookstore, wood shelves, reading nook'],
                    ['id' => 'bar_lounge',       'name' => __('酒吧', 'linked3'),       'name_en' => 'bar lounge',          'prompt_keywords' => 'dim bar, bottles on shelf, neon backlight'],
                    ['id' => 'gym_fitness',      'name' => __('健身房', 'linked3'),     'name_en' => 'gym',                 'prompt_keywords' => 'modern gym, weights, mirror wall'],
                    ['id' => 'cafe_workspace',   'name' => __('咖啡馆', 'linked3'),     'name_en' => 'cafe workspace',      'prompt_keywords' => 'cozy cafe, laptop, latte art'],
                ],
            ],
            [
                ...
                'scenes' => [
                    ['id' => 'museum_hall',      'name' => __('博物馆', 'linked3'),     'name_en' => 'museum hall',         'prompt_keywords' => 'museum gallery, exhibits, spotlight'],
                    ['id' => 'theater_stage',    'name' => __('剧院', 'linked3'),       'name_en' => 'theater stage',       'prompt_keywords' => 'theater stage, red curtain, spotlight beam'],
                    ['id' => 'library_reading',  'name' => __('图书馆', 'linked3'),     'name_en' => 'library reading room','prompt_keywords' => 'grand library, reading desks, green lamp light'],
                    ['id' => 'cathedral',        'name' => __('教堂', 'linked3'),       'name_en' => 'cathedral',           'prompt_keywords' => 'gothic cathedral, stained glass, nave light'],
                    ['id' => 'temple_censer',    'name' => __('寺庙', 'linked3'),       'name_en' => 'temple',              'prompt_keywords' => 'eastern temple, incense smoke, red lantern'],
                    ['id' => 'art_gallery',      'name' => __('美术馆', 'linked3'),     'name_en' => 'art gallery',         'prompt_keywords' => 'white cube gallery, framed art, polished floor'],
                ],
            ],
            [
                'category_id'   => 'outdoor',
                ...
                'scenes' => [
                    ['id' => 'city_park',        'name' => __('城市公园', 'linked3'),   'name_en' => 'city park',           'prompt_keywords' => 'urban park, lawn, tree-lined path'],
                    ['id' => 'central_square',   'name' => __('中央广场', 'linked3'),   'name_en' => 'central square',      'prompt_keywords' => 'city central square, fountain, crowd'],
                    ['id' => 'stadium_crowd',    'name' => __('体育场', 'linked3'),     'name_en' => 'stadium',             'prompt_keywords' => 'sports stadium, tiered seats, floodlights'],
                    ['id' => 'campus_quad',      'name' => __('校园', 'linked3'),       'name_en' => 'campus quad',         'prompt_keywords' => 'university campus, quadrangle, students'],
                    ['id' => 'amusement_park',   'name' => __('游乐场', 'linked3'),     'name_en' => 'amusement park',      'prompt_keywords' => 'amusement park, carousel, fairy lights'],
                    ['id' => 'seaside_promenade','name' => __('海滨长廊', 'linked3'),   'name_en' => 'seaside promenade',   'prompt_keywords' => 'seaside promenade, railings, sunset glow'],
                ],
            ],
            [
                ...
                'scenes' => [
                    ['id' => 'modern_factory',   'name' => __('现代工厂', 'linked3'),   'name_en' => 'modern factory',      'prompt_keywords' => 'clean modern factory, robotic arms, production line'],
                    ['id' => 'science_lab',      'name' => __('科学实验室', 'linked3'), 'name_en' => 'science lab',         'prompt_keywords' => 'research lab, fume hood, glass beakers'],
                    ['id' => 'data_center',      'name' => __('数据中心', 'linked3'),   'name_en' => 'data center',         'prompt_keywords' => 'server room, blue LED rows, raised floor'],
                    ['id' => 'construction_site','name' => __('建筑工地', 'linked3'),   'name_en' => 'construction site',   'prompt_keywords' => 'construction site, tower crane, scaffolding'],
                    ['id' => 'port_dock',        'name' => __('港口码头', 'linked3'),   'name_en' => 'port dock',           'prompt_keywords' => 'cargo port, container stacks, gantry crane'],
                    ['id' => 'space_launchpad',  'name' => __('航天发射场', 'linked3'), 'name_en' => 'space launchpad',     'prompt_keywords' => 'rocket launchpad, gantry tower, dusk horizon'],
                    ['id' => 'smart_warehouse',  'name' => __('智能仓储', 'linked3'),   'name_en' => 'smart warehouse',     'prompt_keywords' => 'automated warehouse, AGV robots, rack aisles'],
                ],
            ],
        ];
    }
    ...
    public static function route_skeleton(string $l1, string $l2, string $l3): string
    {
        ...
        if (class_exists('\Linked3\Classes\Genesis\SkeletonLibrary') && method_exists('\Linked3\Classes\Genesis\SkeletonLibrary', 'route')) {
            try {
                ...
                Logger::instance()->warning('ai', "Scene axis AI failed: " . $e->getMessage());
            }
        }
