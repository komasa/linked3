<?php
/**
 * Seed Admin — Rendering (G4.1 split from Linked3_Seed_Admin).
 *
 * @package Linked3
...
class Linked3_Seed_Admin_Render
{
    ...
    public static function print_inline_assets() : mixed {
        ...
        public static function render_list_page() : mixed { return Linked3_Seed_Admin_Pages::render_list_page(); }

        public static function render_edit_page() : mixed { return Linked3_Seed_Admin_Pages::render_edit_page(); }

        public static function render_new_page() : mixed { return Linked3_Seed_Admin_Pages::render_new_page(); }
    ...
    : void {
        ...
        if ($action === 'trash') {
            foreach ($ids as $pid) {
                Linked3_Genesis_Seed_CPT::trash($pid);
            }
