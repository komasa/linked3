...
class GenesisRecommendationEngine
{
    ...
    private $modes = [
        'auto' => [
            'name_cn' => __('一键智能推荐', 'linked3'),
            'description' => __('AI分析内容，自动推荐Top-3', 'linked3'),
            'top_n' => 3,
            'filters' => [],
        ],
        'beginner' => [
            'name_cn' => __('新手友好推荐', 'linked3'),
            'description' => __('优先推荐低门槛风格，附带操作指引', 'linked3'),
            'top_n' => 3,
            'filters' => ['exclude_categories' => ['科幻未来', '西方灵异', '东方灵异']],
        ],
        'designer' => [
            'name_cn' => __('设计师精选', 'linked3'),
            'description' => __('推荐专业风格，支持精细调整', 'linked3'),
            'top_n' => 5,
            'filters' => ['include_categories' => ['商业生产级信息图', '商业生产级信息图-融合技法', '商业生产级信息图-万兴垂直']],
        ],
        'market' => [
            'name_cn' => __('万兴市场优选', 'linked3'),
            'description' => __('强制过滤万兴适配风格', 'linked3'),
            'top_n' => 3,
            'filters' => ['require_wondershare_ready' => true],
        ],
        'industry' => [
            'name_cn' => __('行业专家推荐', 'linked3'),
            'description' => __('按行业匹配垂直风格', 'linked3'),
            'top_n' => 3,
            'filters' => ['match_industry' => true],
        ],
        'accessible' => [
            'name_cn' => __('无障碍优先', 'linked3'),
            'description' => __('推荐高对比、大字号风格', 'linked3'),
            'top_n' => 3,
            'filters' => ['require_accessible' => true],
        ],
        'conversion' => [
            'name_cn' => __('高转化推荐', 'linked3'),
            'description' => __('推荐CTA导向风格', 'linked3'),
            'top_n' => 3,
            'filters' => ['match_function' => 'CTA'],
        ],
        'complex' => [
            'name_cn' => __('复杂内容推荐', 'linked3'),
            'description' => __('推荐融合风格', 'linked3'),
            'top_n' => 3,
            'filters' => ['include_categories' => ['商业生产级信息图-融合技法']],
        ],
        'cross-platform' => [
            'name_cn' => __('跨平台适配', 'linked3'),
            'description' => __('多平台风格组合', 'linked3'),
            'top_n' => 5,
