...
final class SEOHooksRegistrar
{
     ...
     * @return void
     */
    static function register_metaboxes(): void {
     ...
     * @return void
     */
    static function render_push_logs(): void {
        if (!current_user_can('edit_posts')) {
            return;
        }
     ...
     * @return void
     */
    static function render_settings(): void {
     ...
     * @return void
     */
    static function render_scorecard_metabox(WP_Post $post): void {
     ...
     * @return void
     */
    static function output_schema_markup(): void {
        if (is_admin()) {
            return;
        }
     ...
     * @return void
     */
    static function enqueue_metabox_assets(string $hook): void {
