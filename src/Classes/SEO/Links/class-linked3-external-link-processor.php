 ...
 *
 * Configuration (Linked3_SEO_Config::get('external')):
...
final class Linked3_External_Link_Processor
{
    ...
    public static function process($content) : mixed {
        ...
        self::$ctx_nofollow_default = (bool) Linked3_SEO_Config::get('external.nofollow_default', true);
        self::$ctx_whitelist = (array) Linked3_SEO_Config::get('external.whitelist', []);
        self::$ctx_sponsored = (array) Linked3_SEO_Config::get('external.sponsored_hosts', []);
