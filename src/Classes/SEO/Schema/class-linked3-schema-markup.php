...
final class Linked3_Schema_Markup
{
    /** @var self|null */
    private static $instance;

    /** @var array<string,Linked3_Schema_Builder> type → builder */
    private $builders = [];
    ...
    private function __construct() {
        $this->enabled = array_fill_keys((array) Linked3_SEO_Config::get('schema.enabled_types', []), true);
    ...
    : void {
        $this->register(new Linked3_Schema_Article());
        $this->register(new Linked3_Schema_BlogPosting());
        $this->register(new Linked3_Schema_FAQ());
        $this->register(new Linked3_Schema_Product());
        $this->register(new Linked3_Schema_HowTo());
        /**
    ...
    /**
     * @param Linked3_Schema_Builder $builder
     * @return void
     */
    public function register(Linked3_Schema_Builder $builder)
    : void {
