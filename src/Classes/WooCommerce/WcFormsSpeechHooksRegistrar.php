...
final class WcFormsSpeechHooksRegistrar
{
    ...
    public static function wc_generate_desc()
    : void {
    ...
    public static function wc_generate_reviews()
    : void {
        self::verify_admin('linked3_wc');
        self::require_pro();
     ...
     */
    public static function wc_generate_image()
    : void {
        self::verify_admin('linked3_wc');
        self::require_pro();
        $pid = (int) ($_POST['product_id'] ?? 0);
    ...
    public static function tts_synthesize()
    : void {
    ...
    public static function render_wc_page()
    : void {
    ...
    public static function render_speech_page()
    : void {
        if (!current_user_can('manage_options')) return;
