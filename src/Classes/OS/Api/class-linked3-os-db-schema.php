<?php
/**
 * Linked3 Linked3_OS_Db_Schema 15.0.0-rc9
 *
 * 数据库表创建
 *
 ...
 * Original class: Linked3_V18_Db_Schema
 *
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Api\Linked3_OS_Db_Schema')) {
    add_action('init', ['\Linked3\Classes\OS\Api\Linked3_OS_Db_Schema', 'register'], 10);
}
