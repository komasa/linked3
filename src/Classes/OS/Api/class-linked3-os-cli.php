<?php
/**
 * Linked3 Linked3_OS_Cli 15.0.0-rc6
 *
 * WP-CLI命令
 *
 ...
 * Original class: Linked3_V18_Cli
 *
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Api\Linked3_OS_Cli')) {
    add_action('init', ['\Linked3\Classes\OS\Api\Linked3_OS_Cli', 'register'], 10);
}
