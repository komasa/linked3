 ...
 * Original class: Linked3_V18_Integration_Hub_V2
 *
...
class Linked3_OS_Integration_Hub_V2 {
    ...
    const INTEGRATED_MODULES_V2 = [
        ...
        // v13.0.0 集成中心v1
        'v13.0.0' => ['class' => 'Linked3_V18_Integration_Hub', 'type' => 'hub', 'title' => 'V18集成中心v1'],
        ...
        'v15.0.0-rc1' => ['class' => 'Linked3_V18_Dashboard', 'type' => 'admin', 'title' => 'V18管理后台仪表盘'],
        'v15.0.0-rc2' => ['class' => 'Linked3_V18_Reverse_Panel', 'type' => 'admin', 'title' => '逆向拆解操作面板'],
        'v15.0.0-rc3' => ['class' => 'Linked3_V18_Svg_Stats_Panel', 'type' => 'admin', 'title' => 'SVG统计可视化面板'],
        'v15.0.0-rc4' => ['class' => 'Linked3_V18_Ruliu_Panel', 'type' => 'admin', 'title' => '入流追踪进度面板'],
        'v15.0.0-rc5' => ['class' => 'Linked3_V18_Rest_Api', 'type' => 'rest', 'title' => 'REST API端点注册'],
        'v15.0.0-rc6' => ['class' => 'Linked3_V18_Cli', 'type' => 'cli', 'title' => 'WP-CLI命令'],
        'v15.0.0-rc7' => ['class' => 'Linked3_V18_Shortcodes', 'type' => 'shortcode', 'title' => '短代码支持'],
        'v15.0.0-rc8' => ['class' => 'Linked3_V18_Widget', 'type' => 'widget', 'title' => '小工具(Widget)'],
        'v15.0.0-rc9' => ['class' => 'Linked3_V18_Db_Schema', 'type' => 'db', 'title' => '数据库表创建'],
    ];
