<?php
/**
 * Linked3 Linked3_OS_Widget 15.0.0-rc8
 *
 * 小工具(Widget)
 *
 * 侧边栏小工具: 入流进度/质量门禁
 ...
 * Original class: Linked3_V18_Widget
 *
...
class Linked3_OS_Widget extends \WP_Widget {
    ...
    public static function register_widget(): void {
        register_widget('Linked3_OS_Widget');
    }
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Api\Linked3_OS_Widget')) {
    add_action('init', ['\Linked3\Classes\OS\Api\Linked3_OS_Widget', 'register'], 10);
}
