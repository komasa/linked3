<?php
/**
 * Linked3 Linked3_OS_Shortcodes 15.0.0-rc7
 *
 * 短代码支持
 *
 ...
 * Original class: Linked3_V18_Shortcodes
 *
...
class Linked3_OS_Shortcodes {
    ...
    public static function shortcode_health(array $atts): string {
        ...
        $health = Linked3_V18_Integration_Hub::health_check();
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Api\Linked3_OS_Shortcodes')) {
    add_action('init', ['\Linked3\Classes\OS\Api\Linked3_OS_Shortcodes', 'register'], 10);
}
