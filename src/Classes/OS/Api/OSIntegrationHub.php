...
class OSIntegrationHub {
    ...
    const INTEGRATED_MODULES = [
        'v12.0.0' => [
            ...
            'title' => __('逆向8维度通用框架引擎', 'linked3'),
            'v18_source' => __('道篇2.3+术篇8.2', 'linked3'),
        ],
        'v12.1.0' => [
            'class' => 'OSCapabilityLock',
            'file' => 'NengSuoStructure.php',
            'path' => 'src/Classes/Philosophy/',
            'title' => __('李善友能所结构融入', 'linked3'),
            'v18_source' => __('道篇2.4', 'linked3'),
        ],
        'v12.2.0' => [
            'class' => 'OSVisualAnalytics',
            'file' => 'SvgMetaStats.php',
            'path' => 'src/Classes/SvgStats/',
            'title' => __('SVG原子级meta统计引擎', 'linked3'),
            'v18_source' => __('法篇6+术篇13', 'linked3'),
        ],
        'v12.3.0' => [
            'class' => 'OSConsciousnessLayer',
            'file' => 'ThreeLayerConsciousness.php',
            'path' => 'src/Classes/Philosophy/',
            'title' => __('三层能观Badge频率标注', 'linked3'),
            'v18_source' => __('道篇2.5', 'linked3'),
        ],
        'v12.4.0' => [
            'class' => 'OSOnboardingTracker',
            'file' => 'RuLiuTracker.php',
            'path' => 'src/Classes/Philosophy/',
            'title' => __('入流四状态100天追踪器', 'linked3'),
            'v18_source' => __('道篇2.7+行篇33.3', 'linked3'),
        ],
        'v12.5.0' => [
            'class' => 'OSEngineerRegistry',
            'file' => 'ReverseEngineerRegistry.php',
            'path' => 'src/Classes/Reverse/',
            'title' => __('31类逆向工程师注册中心', 'linked3'),
            'v18_source' => __('道篇2.3+附录A', 'linked3'),
        ],
        'v12.6.0' => [
            'class' => 'OSTextCreation',
            'file' => 'ReverseTextCreation.php',
            'path' => 'src/Classes/Reverse/',
            'title' => __('逆向文本创作8维度', 'linked3'),
            'v18_source' => __('用篇28-30', 'linked3'),
        ],
        'v12.7.0' => [
            'class' => 'OSMomentumFlywheel',
            'file' => 'HongLiuFlywheel.php',
            'path' => 'src/Classes/Philosophy/',
            'title' => __('洪流公式出图飞轮量化', 'linked3'),
            'v18_source' => __('道篇2.6', 'linked3'),
        ],
        'v12.8.0' => [
            'class' => 'OSCapabilityStages',
            'file' => 'NengZhiThreeStages.php',
            'path' => 'src/Classes/Philosophy/',
            'title' => __('能知三阶认知层级映射', 'linked3'),
            'v18_source' => __('道篇2.5', 'linked3'),
        ],
        'v12.9.0' => [
            'class' => 'OSQualityGate',
            ...
            'path' => 'src/Classes/Reverse/',
            'title' => __('逆向质量门禁系统', 'linked3'),
            'v18_source' => __('验篇41.4', 'linked3'),
        ],
    ];
