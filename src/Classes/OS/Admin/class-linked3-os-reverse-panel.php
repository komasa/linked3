<?php
/**
 * Linked3 Linked3_OS_Reverse_Panel 15.0.0-rc2
 *
 * 逆向拆解操作面板
 *
 * 逆向拆解操作界面+JSON结果展示
 ...
 * Original class: Linked3_V18_Reverse_Panel
 *
...
class Linked3_OS_Reverse_Panel {
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Admin\Linked3_OS_Reverse_Panel')) {
    add_action('init', ['\Linked3\Classes\OS\Admin\Linked3_OS_Reverse_Panel', 'register'], 10);
}
