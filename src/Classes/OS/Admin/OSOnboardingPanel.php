...
/**
 * Linked3 OSOnboardingPanel 15.0.0-rc4
 *
 * 入流追踪进度面板
 *
 * 100天进度可视化
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Admin\OSOnboardingPanel')) {
    add_action('init', ['\Linked3\Classes\OS\Admin\OSOnboardingPanel', 'register'], 10);
}
