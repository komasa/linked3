<?php
/**
 * Linked3 Linked3_OS_Dashboard 15.0.0-rc1
 *
 * V18管理后台仪表盘
 *
 * 10个模块状态总览+健康检查面板
 ...
 * Original class: Linked3_V18_Dashboard
 *
...
class Linked3_OS_Dashboard {
    ...
    public static function run_health_check(): array {
        if (class_exists('\Linked3\Classes\OS\Admin\Linked3_V18_Integration_Hub')) {
            return Linked3_V18_Integration_Hub::health_check();
        }
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Admin\Linked3_OS_Dashboard')) {
    add_action('init', ['\Linked3\Classes\OS\Admin\Linked3_OS_Dashboard', 'register'], 10);
}
