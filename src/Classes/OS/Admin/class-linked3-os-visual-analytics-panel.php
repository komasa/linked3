<?php
/**
 * Linked3 Linked3_OS_Visual_Analytics_Panel 15.0.0-rc3
 *
 * SVG统计可视化面板
 *
 * SVG统计图表展示
 ...
 * Original file: src/Classes/V18/Admin/class-linked3-v18-svg-stats-panel.php
 * Original class: Linked3_V18_Svg_Stats_Panel
 *
...
class Linked3_OS_Visual_Analytics_Panel {
...
// 注册模块
if (class_exists('\Linked3\Classes\OS\Admin\Linked3_OS_Visual_Analytics_Panel')) {
    add_action('init', ['\Linked3\Classes\OS\Admin\Linked3_OS_Visual_Analytics_Panel', 'register'], 10);
}
