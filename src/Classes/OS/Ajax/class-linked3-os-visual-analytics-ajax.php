<?php
/**
 * Linked3 Linked3_OS_Visual_Analytics_Ajax 14.2.0
 *
 * SVG统计AJAX接口
 *
 ...
 * Original file: src/Classes/V18/Ajax/class-linked3-svg-stats-ajax.php
...
class Linked3_OS_Visual_Analytics_Ajax {
...
// 注册AJAX
if (class_exists('\Linked3\Classes\OS\Ajax\Linked3_OS_Visual_Analytics_Ajax')) {
    add_action('init', ['\Linked3\Classes\OS\Ajax\Linked3_OS_Visual_Analytics_Ajax', 'register'], 5);
}
