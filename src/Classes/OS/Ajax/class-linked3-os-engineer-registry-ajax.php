<?php
/**
 * Linked3 Linked3_OS_Engineer_Registry_Ajax 14.5.0
 *
 * 31类工程师AJAX接口
 *
 ...
 * Original file: src/Classes/V18/Ajax/class-linked3-engineer-registry-ajax.php
...
class Linked3_OS_Engineer_Registry_Ajax {
...
// 注册AJAX
if (class_exists('\Linked3\Classes\OS\Ajax\Linked3_OS_Engineer_Registry_Ajax')) {
    add_action('init', ['\Linked3\Classes\OS\Ajax\Linked3_OS_Engineer_Registry_Ajax', 'register'], 5);
}
