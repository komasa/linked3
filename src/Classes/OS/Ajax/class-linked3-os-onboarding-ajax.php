<?php
/**
 * Linked3 Linked3_OS_Onboarding_Ajax 14.4.0
 *
 * 入流追踪AJAX接口
 *
 ...
 * Original file: src/Classes/V18/Ajax/class-linked3-ru-liu-ajax.php
...
class Linked3_OS_Onboarding_Ajax {
...
// 注册AJAX
if (class_exists('\Linked3\Classes\OS\Ajax\Linked3_OS_Onboarding_Ajax')) {
    add_action('init', ['\Linked3\Classes\OS\Ajax\Linked3_OS_Onboarding_Ajax', 'register'], 5);
}
