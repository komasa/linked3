<?php
/**
 * Linked3 Linked3_OS_Text_Creation_Ajax 14.6.0
 *
 * 逆向文本AJAX接口
 *
...
class Linked3_OS_Text_Creation_Ajax {
...
// 注册AJAX
if (class_exists('\Linked3\Classes\OS\Ajax\Linked3_OS_Text_Creation_Ajax')) {
    add_action('init', ['\Linked3\Classes\OS\Ajax\Linked3_OS_Text_Creation_Ajax', 'register'], 5);
}
