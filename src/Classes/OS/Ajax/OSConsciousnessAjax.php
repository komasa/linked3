...
/**
 * Linked3 OSConsciousnessAjax 14.3.0
 *
 * 三层能观AJAX接口
 *
...
// 注册AJAX
if (class_exists('\Linked3\Classes\OS\Ajax\OSConsciousnessAjax')) {
    add_action('init', ['\Linked3\Classes\OS\Ajax\OSConsciousnessAjax', 'register'], 5);
}
