...
// 注册AJAX
if (class_exists('\Linked3\Classes\OS\Ajax\OSMomentumAjax')) {
    add_action('init', ['\Linked3\Classes\OS\Ajax\OSMomentumAjax', 'register'], 5);
}
