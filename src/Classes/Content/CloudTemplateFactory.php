...
class CloudTemplateFactory {
    ...
    private static function get_builtin_masters(): array {
        return [
            'content' => [
                'name' => __('通用文章模版', 'linked3'),
                'type' => 'content',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v10.7 | 通用文章', 'linked3'),
                    'role' => __('专业内容创作者', 'linked3'),
                    'scene' => __('博客文章/公众号/知识库', 'linked3'),
                    'background' => __('面向搜索引擎和读者, 兼顾SEO与可读性', 'linked3'),
                    'goals' => ['信息传递', '价值输出', 'SEO友好'],
                    'skills' => ['结构化写作', '关键词布局', '用户洞察', '数据驱动'],
                    'style' => __('专业', 'linked3'),
                    'limit' => ['字数800-2000', '段落≤5行', 'H2≥3个'],
                    'step' => ['选题定位', '关键词收集', '大纲构建', '正文撰写', '质检优化'],
                    'output' => __('Markdown格式, 含H1/H2/H3', 'linked3'),
                ],
            ],
            'seo' => [
                'name' => __('SEO优化模版', 'linked3'),
                'type' => 'seo',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v10.7 | SEO优化', 'linked3'),
                    'role' => __('SEO优化专家', 'linked3'),
                    'scene' => __('搜索引擎优化场景', 'linked3'),
                    'background' => __('以关键词为核心, 提升搜索排名和点击率', 'linked3'),
                    'goals' => ['关键词覆盖', '排名提升', '点击率优化'],
                    'skills' => ['关键词研究', '竞品分析', '内容优化', '数据驱动'],
                    'style' => __('专业', 'linked3'),
                    'limit' => ['关键词密度2-3%', '标题≤60字', '描述≤160字'],
                    'step' => ['关键词分析', '竞品研究', '标题优化', '内容撰写', 'Meta优化'],
                    'output' => __('标题+描述+正文+关键词列表', 'linked3'),
                ],
            ],
            'social' => [
                'name' => __('社媒种草模版', 'linked3'),
                'type' => 'social',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v10.7 | 社媒种草', 'linked3'),
                    'role' => __('社交媒体运营', 'linked3'),
                    'scene' => __('小红书/微博/抖音', 'linked3'),
                    'background' => __('以用户互动为核心, 引导种草和转化', 'linked3'),
                    'goals' => ['互动引导', '种草转化', '传播扩散'],
                    'skills' => ['情绪共鸣', '场景化描述', '互动设计', '标签策略'],
                    'style' => __('轻松', 'linked3'),
                    'limit' => ['标题≤22字', '正文≤1000字', '标签5-8个'],
                    'step' => ['选题定位', '标题钩子', '正文撰写', '标签优化', '发布建议'],
                    'output' => __('标题+正文+标签+发布建议', 'linked3'),
                ],
            ],
            'video' => [
                'name' => __('视频脚本模版', 'linked3'),
                'type' => 'video',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v10.7 | 视频脚本', 'linked3'),
                    'role' => __('视频脚本编剧', 'linked3'),
                    'scene' => __('短视频/中视频', 'linked3'),
                    'background' => __('9页SOP分镜结构, 3秒钩子+完播率优化', 'linked3'),
                    'goals' => ['3秒钩子', '完播率', '互动引导'],
                    'skills' => ['分镜设计', '旁白撰写', '字幕精炼', '节奏控制'],
                    'style' => __('口语化', 'linked3'),
                    'limit' => ['时长60-180秒', '每15秒转折', '3秒钩子'],
                    'step' => ['选题定位', '分镜设计', '旁白撰写', '字幕精炼', '品牌闭环'],
                    'output' => __('分镜脚本+台词+动作指导', 'linked3'),
                ],
            ],
            'comic' => [
                'name' => __('漫画分镜模版', 'linked3'),
                'type' => 'comic',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v10.7 | 漫画分镜', 'linked3'),
                    'role' => __('漫画脚本作者', 'linked3'),
                    'scene' => __('漫画分镜', 'linked3'),
                    'background' => __('分镜清晰, 角色DNA一致, 剧情推进', 'linked3'),
                    'goals' => ['分镜清晰', '角色一致', '剧情推进'],
                    'skills' => ['分镜设计', '角色塑造', '对话撰写', '画面描述'],
                    'style' => __('叙事', 'linked3'),
                    'limit' => ['分镜5-10个', '每镜1图', '角色DNA一致'],
                    'step' => ['角色设计', '分镜规划', '对话撰写', '画面描述', '质检优化'],
                    'output' => __('分镜列表+Prompt+角色DNA', 'linked3'),
                ],
            ],
            'charts' => [
                'name' => __('图示脚本模版', 'linked3'),
                'type' => 'charts',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v10.7 | 图示脚本', 'linked3'),
                    'role' => __('图示内容设计师', 'linked3'),
                    'scene' => __('信息图/图文卡片', 'linked3'),
                    'background' => __('4Band结构(Hook/Body/Proof/CTA), 信息密度高', 'linked3'),
                    'goals' => ['吸引注意', '信息传递', '行动号召'],
                    'skills' => ['4Band结构', '视觉设计', '文案精炼', '品牌一致'],
                    'style' => __('信息图', 'linked3'),
                    'limit' => ['模块4-8个', '每模块1图', '文字精炼'],
                    'step' => ['内容拆分', '4Band分配', '视觉Prompt', '文字叠加', '布局优化'],
                    'output' => __('模块列表+视觉Prompt+文字叠加', 'linked3'),
                ],
            ],
            // v11.1.0 #2: 补充genesis漫画脚本母版
            'genesis' => [
                'name' => __('漫画分镜母版', 'linked3'),
                'type' => 'genesis',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v11.1 | 漫画分镜', 'linked3'),
                    'role' => __('漫画脚本作者', 'linked3'),
                    'scene' => __('漫画分镜/连环画', 'linked3'),
                    'background' => __('分镜清晰, 角色DNA一致, 剧情推进, 适合多格漫画', 'linked3'),
                    'goals' => ['分镜清晰', '角色一致', '剧情推进', '画面表现力'],
                    'skills' => ['分镜设计', '角色塑造', '对话撰写', '画面描述', '节奏控制'],
                    'style' => __('叙事', 'linked3'),
                    'limit' => ['分镜5-15个', '每镜1图', '角色DNA一致', '对话简洁'],
                    'step' => ['角色设计', '分镜规划', '对话撰写', '画面描述', '质检优化'],
                    'output' => __('分镜列表+Prompt+角色DNA+对话', 'linked3'),
                ],
            ],
            'tutorial' => [
                'name' => __('教程攻略母版', 'linked3'),
                'type' => 'tutorial',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v11.1 | 教程攻略', 'linked3'),
                    'role' => __('技术教程作者', 'linked3'),
                    'scene' => __('教程/攻略/How-to', 'linked3'),
                    'background' => __('面向学习者, 步骤清晰, 可操作性强', 'linked3'),
                    'goals' => ['教会读者', '步骤清晰', '可操作', '常见问题解答'],
                    'skills' => ['步骤拆解', '截图标注', '代码示例', '常见错误提示'],
                    'style' => __('教程', 'linked3'),
                    'limit' => ['步骤≥5步', '每步配截图', '代码可复制'],
                    'step' => ['需求分析', '环境准备', '步骤拆解', '截图标注', 'FAQ补充'],
                    'output' => __('步骤列表+截图+代码+FAQ', 'linked3'),
                ],
            ],
            'review' => [
                'name' => __('评测对比母版', 'linked3'),
                'type' => 'review',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v11.1 | 评测对比', 'linked3'),
                    'role' => __('产品评测师', 'linked3'),
                    'scene' => __('产品评测/对比测评', 'linked3'),
                    'background' => __('客观对比, 数据支撑, 帮助用户决策', 'linked3'),
                    'goals' => ['客观评测', '数据对比', '优缺点分析', '购买建议'],
                    'skills' => ['产品分析', '数据对比', '优缺点提炼', '结论给出'],
                    'style' => __('客观', 'linked3'),
                    'limit' => ['对比维度≥5个', '有数据支撑', '结论明确'],
                    'step' => ['产品概述', '维度选择', '对比分析', '优缺点总结', '购买建议'],
                    'output' => __('对比表格+优缺点+购买建议', 'linked3'),
                ],
            ],
            'news' => [
                'name' => __('资讯快讯母版', 'linked3'),
                'type' => 'news',
                'is_builtin' => true,
                'config' => [
                    'profile' => __('Linked3 v11.1 | 资讯快讯', 'linked3'),
                    'role' => __('科技资讯编辑', 'linked3'),
                    'scene' => __('新闻资讯/快讯', 'linked3'),
                    'background' => __('时效性强, 要点突出, 适合快速阅读', 'linked3'),
                    'goals' => ['信息传递', '时效性', '要点突出', '引发关注'],
                    'skills' => ['信息提炼', '标题制作', '要点总结', '背景补充'],
                    'style' => __('新闻', 'linked3'),
                    'limit' => ['字数300-800', '导语≤50字', '要点3-5个'],
                    'step' => ['信息收集', '要点提炼', '导语撰写', '正文展开', '背景补充'],
                    'output' => __('标题+导语+要点+正文', 'linked3'),
                ],
            ],
        ];
    }
    ...
    private static function get_default_template(string $category): array {
        return [
            ...
            'config' => [
                ...
                'role' => __('内容创作者', 'linked3'),
                'scene' => __('通用场景', 'linked3'),
                'background' => '',
                'goals' => ['内容产出'],
                'skills' => ['结构化写作'],
                'style' => 'professional',
